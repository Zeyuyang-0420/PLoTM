"use strict";
const DISABLED_MSG = "<b>Claude chat is disabled on this public deployment.</b><br>The live assistant runs a server-side Claude API loop, which is not available on the static GitHub Pages site. Please watch the <b>demo video</b> to see the chat in action.";
...
// ---------- init ----------
async function init(){
  const r = await fetch("data/demo_data.json");
